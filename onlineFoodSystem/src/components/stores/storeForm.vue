        ...
        <div class="addGoodDialog">
          <el-form :model="good" :rules="rules" ref="editGoodForm" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="商家地址" prop="address">
               <el-input v-model="good.address"></el-input>
            </el-form-item>
            <el-form-item label="商家电话" prop="phone">
               <el-input v-model="good.phone"></el-input>
            </el-form-item>
            <el-form-item label="商家起送价" prop="startPrice">
               <el-input v-model.number="good.startPrice"></el-input>
            </el-form-item>
            <el-form-item label="商家配送费" prop="deliveryPrice">
               <el-input v-model.number="good.deliveryPrice"></el-input>
            </el-form-item>
